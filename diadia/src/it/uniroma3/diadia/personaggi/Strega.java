...
public class Strega extends AbstractPersonaggio {
	...
	public Stanza stanzaConMaxAtt(Map<Direzione,Stanza> mappa) {
		boolean maxSegnato=false;
		Stanza max=null;
		for(Map.Entry<Direzione, Stanza> entry:mappa.entrySet()) {
			if(!maxSegnato) {
				max=entry.getValue();
				maxSegnato=true;}
	...
	public Stanza stanzaConMinAtt(Map<Direzione,Stanza> mappa) {
